...
categories[1840]['genus']='Dryas1'
categories[4583]['genus']='Morus1'
categories[4584]['genus']='Morus1'
categories[8686]['genus']='Scoparia1'
categories[3827]['genus']='Linaria1'
categories[8479]['genus']='Prunella1'
categories[2174]['genus']='Amorpha1'
categories[7421]['genus']='Arenaria1'
categories[1194]['genus']='Dysphania1'
categories[986]['genus']='Brunia1'
categories[6649]['genus']='Baileya1'
categories[3990]['genus']='Oenanthe1'
categories[3991]['genus']='Oenanthe1'
categories[6355]['genus']='Chloris1'
categories[799]['genus']='Ammophila1'
categories[1152]['genus']='Anticlea1'
categories[5797]['genus']='Colocasia1'

categories[2280]['genus']='Iris1'

categories[8540]['genus']='Proboscidea1'
categories[8541]['genus']='Proboscidea1'
...
# pickle nltk tree
with open(os.path.join(opts.out_dir, 'inaturalist21_tree.pkl'), 'wb') as f:
...
with open(os.path.join(opts.out_dir, 'inaturalist21_hierarchy.txt'), 'w') as f:
    f.write(fmt)